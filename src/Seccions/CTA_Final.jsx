  ...
  return (
    <section className="bg-verde-olivo mx-auto py-10">
        ...
        <div className="flex gap-6 justify-center items-center m-2">
            <button className="bg-naranja text-white text-[16.8px] px-10 rounded p-4 font-bold transition-all duration-300 hover:-translate-y-1 hover:cursor-pointer">Agenda una sesión diagnóstica gratuita</button>
        </div>
    </section>
  )
}
