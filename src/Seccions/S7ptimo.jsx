  ...
  return (
    <section className="bg-black py-16 relative overflow-hidden font-garamond">
        ...
        <div className="flex justify-start">
          <img src={Logo} alt="S7PTIMO_Logo" className="w-56 md:w-80 object-contain drop-shadow-lg"/>
        </div>
        <p className="hueso text-[18px]">Programación Escénica Contemporánea en S7ptimo, Foro Coyoacán</p>
        <p className="hueso text-[18px]">Un espacio dedicado a la escena contemporánea en Coyoacán, Ciudad de México. Impulsamos propuestas que exploran nuevos lenguajes, formatos y temáticas urgentes.</p>
        <p className="hueso text-[18px]">Una programación en proceso, en diálogo constante con su escena.</p>
