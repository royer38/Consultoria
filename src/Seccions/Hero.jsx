  ...
  return (
    <article className="bg-verde-olivo py-20">
      <section className=" text-center flex flex-col gap-9">
        ...
        <p className="text-[1.15rem] text-white">Plataforma de profesionalización especializada en Artes Escénicas, Gestión Cultural, Producción y Vinculación Internacional</p>
