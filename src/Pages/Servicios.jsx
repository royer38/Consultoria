...
{/* prueba para ver como se veria con diseno de imagen */}
            <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-12 items-start mt-20">
                ...
                <div className="w-full h-105 border-3 bg-gray-200 border-[#E85D04] rounded-2xl flex items-center justify-center shrink-0 mx-auto sm:mx-0">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-12 items-start mt-20">
                ...
                Solicitar asesoría
                        ...
                        {/* prueba para ver como se veria con diseno de imagen */}
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-12 items-start mt-20">
                <div className="w-full lg:order-2">
                <div className="flex-col gap-6 lg:order-1 w-full h-105 border-3 bg-verde-olivo border-[#E85D04] rounded-2xl flex items-center justify-center shrink-0 mx-auto sm:mx-0">
                    <img className="w-full h-full object-contain rounded-2xl" src={ILONAFOTOS7} alt="DanielMiranda" draggable={false}/>
                </div>
                </div>
                ...
                <li className="flex gap-4">
                 ...
                 <div className="mt-6 mb-6 flex flex-col sm:flex-row gap-6">
                <button className="bg-[#E85D04] text-white font-bold px-10 py-4 rounded-lg hover:-translate-y-1 hover:bg-[#c94e03] transition duration-300 hover:cursor-pointer">
                Solicitar asesoría
                </button>
            </div>
