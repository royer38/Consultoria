  ...
  return (
    <article>
        ...
        <section className="py-24 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-12 items-start mt-20" id="Consultoria">
                <div className="w-full">
                <div className="w-full h-105 border-3 bg-verde-olivo border-[#E85D04] rounded-2xl flex items-center justify-center shrink-0 mx-auto sm:mx-0">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-12 items-start mt-20" id="Diseno">
                <div className="w-full">
                <div className="w-full h-105 border-3 bg-verde-olivo border-[#E85D04] rounded-2xl flex items-center justify-center shrink-0 mx-auto sm:mx-0">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-12 items-start mt-20" id="Curaduria">
                <div className="w-full">
                <div className="w-full h-105 border-3 bg-verde-olivo border-[#E85D04] rounded-2xl flex items-center justify-center shrink-0 mx-auto sm:mx-0">
        ...
        <section className="bg-verde-olivo py-10 text-center flex flex-col items-center max-w-full mx-auto gap-8">
            <p className="text-white font-bold text-[35.2px]">Platiquemos tu proyecto.</p>
            <p className="text-white/90 text-[18.4px]">Podemos ayudarte a identificar las mejores estrategias para alcanzar tus objetivos.</p>
